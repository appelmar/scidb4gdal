...
namespace scidb4gdal {
    ...
    struct Resolver {
       ...
       public:
         ...
         *
         * This function checks the existance in the class' map for the enum of a given parameter name.
         *
     ...
     * class reads the key-value pairs and assigns it to the internal *Parameters representation (e.g. scidb4gdal::CreationParameters, scidb4gdal::QueryParameters and scidb4gdal::ConnectionParameters).
     *
    ...
    class ParameterParser {
       ...
       protected:
         ...
         * SciDB connection details from that file
         *
       ...
       private:
         ...
         * @return void
         */
        void assignConnectionParameter(string key, string value);
